...
[![Skills](https://img.shields.io/badge/skills-118-blue)](catalog/skill-index.md)
...
- 6 个验证性项目 eval fixtures，覆盖端到端交付、goal-driven delivery、跨工具记忆、设计前端质量、事故学习闭环和 token-efficient LLM I/O
